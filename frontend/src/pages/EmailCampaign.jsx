...
const EmailCampaigns = () => {
  ...
  const glassInputStyle = {
    background: 'linear-gradient(135.75deg, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.8) 100%)',
  ...
  const activeTabStyle = {
    background: 'linear-gradient(135.75deg, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.8) 100%)',
    border: '1px solid rgba(255, 255, 255, 0.4)',
    boxShadow: '0px 5px 5px 0px #00000008, 0px 0px 2px 0px #0000001A, 0px 1px 1px 0px #00000008',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            style={{ ...glassInputStyle, width: '32px', height: '32px', borderRadius: '99px', padding: '8px' }}
          >
      ...
      {/* SUB HEADER */}
      <div className="flex items-center justify-between shrink-0 px-4 mb-4" style={{ height: '34px' }}>
        ...
        <div className="flex items-center" style={{ gap: '8px', height: '32px' }}>
            <button 
                className="flex items-center gap-2 justify-center hover:bg-white/40 transition-colors"
                style={{ ...glassInputStyle, width: '77px', height: '32px', borderRadius: '99px', fontSize: '13px', fontWeight: 600, color: '#0F172A' }}
            >
            ...
            <button 
                ...
                style={{ ...blueButtonStyle, width: '134px', height: '32px', borderRadius: '58px', fontSize: '12px', fontWeight: 600 }}
            >
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative">
        ...
        >
          <div className="relative mb-4">
             <img src={boxIcon} alt="No Campaigns" style={{ width: '74px', height: '74px', objectFit: 'contain' }} />
             <svg className="absolute -top-8 -right-8 w-20 h-20 text-slate-800 pointer-events-none" viewBox="0 0 100 100" style={{ opacity: 0.8 }}>
                <path d="M30,80 Q50,20 80,30" fill="none" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4,3" />
                <path d="M75,25 L80,30 L85,25" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
             </svg>
          </div>
          <h3 className="text-[18px] font-bold text-[#0F172A]">No email campaigns yet</h3>
          <p className="text-slate-500 text-[13px] leading-relaxed mb-4 font-medium">
            You haven't created any email campaigns. Start your first campaign to reach your audience.
          </p>
          <button 
             className="flex items-center justify-center hover:opacity-95 transition-opacity active:scale-95"
             style={{ ...blueButtonStyle, width: '134px', height: '32px', borderRadius: '100px', fontSize: '12px', fontWeight: 600 }}
          >
            Create Campaign
          </button>
        </motion.div>

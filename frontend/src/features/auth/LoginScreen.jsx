            ...
            <div className="flex flex-col items-center transform origin-center scale-100 mbp:scale-125">
                ...
                >
                    <div className="w-[336px] h-[492px] rounded-[26px] p-[20px] border border-white flex flex-col gap-[12px] box-border" style={{ background: 'linear-gradient(135.75deg, rgba(255, 255, 255, 0.54) 0%, rgba(255, 255, 255, 0.48) 100%)' }}>
                        ...
                        <div className="flex flex-col gap-[6px]">
                            ...
                            <div className="p-[1px] rounded-[10px] w-full h-[40px] bg-gradient-to-br from-white/40 to-white/10">
                                <DiamondInput 
                                    value={password} 
                                    onChange={(val) => { setPassword(val); setIsError(false); }} 
                                ...
                                {isError && (
                                    ...
                                    >
                                        <div className="flex items-center gap-[6px]">
                                            ...
                                            <span className="font-sans font-medium text-[11px] text-red-500 leading-none">Incorrect email or password.</span>
                                        </div>
                                        <button onClick={() => setIsError(false)} className="text-red-400 hover:text-red-600">
                                            <X size={12} />
                                        </button>
                                    </motion.div>
                                )}
                        ...
                        <div className="flex items-center justify-between mt-[-4px]">
                            <div className="flex items-center gap-[8px]">
                                <CustomCheckbox />
                                <span className="font-sans font-medium text-[13px] text-[#0F172A] leading-none">Remember me</span>
                            </div>
                            <a href="#" className="font-sans font-medium text-[13px] text-[#335CFF] hover:underline leading-none">
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <div className="w-full flex items-center justify-center gap-[4px] mb-[2px]">
                        <span className="font-sans font-normal text-[14px] text-[#0F172A]">Don't have an account?</span>
                        <Link to="/signup" className="font-sans font-medium text-[14px] text-[#335CFF] hover:underline">
                            Sign up
                        </Link>
                    </div>

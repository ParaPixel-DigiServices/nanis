    ...
    className={({ isActive }) =>
      clsx(
        ...
        isActive || active
          ...
          : "text-slate-900 font-medium hover:bg-white/40",
      )
    }
  >
    ...
    <div className="ml-auto flex items-center gap-1">
      ...
      {count && (
        <span className="text-[10px] font-medium text-slate-500 bg-white/50 px-1.5 rounded-md">
          {count}
        </span>
      )}
    </div>
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <div
            className="flex items-center justify-center bg-slate-900 rounded-full text-white"
      ...
      <div style={{ ...containerStyle, height: "auto" }}>
        <div
          className="px-3 mt-1 mb-1 text-[10px] font-bold text-slate-400 uppercase tracking-wider"
          style={{ fontFamily: '"Inter Display", sans-serif' }}
        >
          General
        </div>
      ...
      >
        ...
        <div
          className="text-[11px] font-medium text-[#70707B] leading-[16px]"
          style={{ fontFamily: '"Inter Display", sans-serif' }}
        >
          3,250 / 10,000 (32.5%)
        </div>
        ...
        <div
          ...
          style={{
            height: "6px",
            borderRadius: "44px",
            border: "1px solid rgba(53, 56, 73, 0.1)",
            backgroundColor: "rgba(53, 56, 73, 0.05)",
          }}
        >
          <div
            ...
            style={{
              width: "32.5%",
              background: "linear-gradient(90deg, #B6B4FF 0%, #534FEB 103.77%)",
            }}
          />
        </div>
